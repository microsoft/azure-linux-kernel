HOWTO: These patches will enable accelerated networking on the upstrem stable 4.9.184 kernel for Linux VM on Hyper-V.

1. Apply the below patches to make SR-IOV work with the 4.9.184 kernel


1.1 checkout the upstream 4.9.184 kernel and set HEAD to 4.9.184
git clone https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable.git
cd ~/linux-stable
git reset --hard v4.9.184
git clean -dxf

1.2 Apply the patches 
First change to top of the 4.9.184 kernel tree:
git am -k ~/azure-linux-kernel/4.9.184/*.patch
